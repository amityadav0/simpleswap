...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1}, []string{"simpleswap", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Pools_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 0, 2, 1, 2, 2}, []string{"simpleswap", "pools", "all"}, "", runtime.AssumeColonVerbOpt(true)))
)
