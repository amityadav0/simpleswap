...
var (
	...
	ErrAlreadyCreatedPool       = sdkerrors.Register(ModuleName, 1101, "pool already exist")
	...
	ErrInvalidAddress           = sdkerrors.Register(ModuleName, 1109, "invalid bech32 address")
