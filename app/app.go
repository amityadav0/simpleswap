...
var (
	...
	ModuleBasics = module.NewBasicManager(
		...
		simpleswapmodule.AppModuleBasic{},
	...
	maccPerms = map[string][]string{
		...
		simpleswapmoduletypes.ModuleName: {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		...
		simpleswapmoduletypes.StoreKey,
	...
	*/
	...
	app.SimpleswapKeeper = *simpleswapmodulekeeper.NewKeeper(
		appCodec,
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(simpleswapmoduletypes.ModuleName)
